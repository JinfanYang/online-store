   ...
   <%@include file="A_HeadMenu.jsp" %>
    ...
    <div class="container-fluid">
      ...
      <!-- side menu -->
        ...
        <%
        	...
        	List<String> colors = pl.findColor(pid);
        %>
        <!-- content -->
        <div class="span9">
		  <div class="row-fluid">
			...
			<div>
				<%
					...
					{
						out.print("<span id='color"+String.valueOf(i)+"'> "+colors.get(i)+" : </span><span id='colorcount"+String.valueOf(i)+"'>"+ pl.countcolor(pid, colors.get(i))+" </span><br>");
						
					}
					out.print("<input type='hidden' value='"+ colors.size()+"' id='count'>");
	...
	<script>
		...
		for(var i = 0; i< parseInt(count); i++){
			pieData.push({
		 		value: parseInt(document.getElementById("colorcount"+i).innerHTML),
		 		color: "#51A351",
		 		highlight: "#6BB56B",
		 		label: document.getElementById("color"+i).innerHTML
		 	});
		}
