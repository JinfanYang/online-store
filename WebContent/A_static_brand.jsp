...
<html>
  <head>
    <meta charset="utf-8">
    <title>Brand Statistics | Admin</title>
  ...
  <body>
      ...
      <!-- side menu -->
       <div class="span3">
        ...
        <%
        	...
        	List<Integer> brandscount = new ArrayList<Integer>();
        	for(int i = 0; i<brands.size();i++){
        		brandscount.add(bl.countOrder(brands.get(i).getBId()));
        	}
		  ...
		  <div class="row-fluid">
			...
			<div>
				<%
					for(int i = 0; i<brands.size(); i++)
					{
						out.print("<span id='brand"+String.valueOf(i)+"'>"+brands.get(i).getBName()+"</span><span id='brandcount"+String.valueOf(i)+"'>"+brandscount.get(i)+" </span><br>");
					}
					out.print("<input type='hidden' value='"+ brands.size()+"' id='count'>");
				%>
			</div>
	...
	<script>
		...
		for(var i = 0; i< parseInt(count); i++){
			pieData.push({
		 		value: parseInt(document.getElementById("brandcount"+i).innerHTML),
		 		color: "#51A351",
		 		highlight: "#6BB56B",
		 		label: document.getElementById("brand"+i).innerHTML
		 	});
		}
