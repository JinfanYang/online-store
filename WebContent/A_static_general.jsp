   ...
   <%@include file="A_HeadMenu.jsp" %>
		  ...
		  <div class="row-fluid">
			...
			<div>
				<%
					...
					{
						out.print("<span id='product"+String.valueOf(i)+"'>"+products.get(i).getPId()+ ": </span><span id='productcount"+String.valueOf(i)+"'>"+pl.countbypid(products.get(i).getPId())+" </span>");
						out.print("<a href='A_static_general_color.jsp?pid="+products.get(i).getPId()+"'> color detail</a>");
						out.print("<a href='A_static_general_size.jsp?pid="+products.get(i).getPId()+"'> size detail</a><br>");
					}
					out.print("<input type='hidden' value='"+ products.size()+"' id='count'>");
				%>
	...
	<script>
		...
		for(var i = 0; i< parseInt(count); i++){
			pieData.push({
		 		value: parseInt(document.getElementById("productcount"+i).innerHTML),
		 		color: "#51A351",
		 		highlight: "#6BB56B",
		 		label: document.getElementById("product"+i).innerHTML
		 	});
		}
